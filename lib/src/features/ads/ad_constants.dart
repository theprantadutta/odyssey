...
/// constants are irrelevant to them.
class AdConstants {
  AdConstants._();

  // ─── Interstitial ──────────────────────────────────────────────────────
  /// Show an interstitial on every Nth qualifying navigation.
  static const int interstitialEveryNNavigations = 4;
  ...
  static const Duration appOpenMinBackgroundDuration = Duration(seconds: 60);
