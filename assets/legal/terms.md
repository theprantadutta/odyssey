...
Welcome to **Odyssey**, a trip planning and travel memory application operated by Pranta Dutta. By downloading, installing, or using the Odyssey mobile application ("App"), you agree to be bound by these Terms & Conditions ("Terms").
...
- When you share a trip with other users, they can view and (if permitted) edit the shared trip data
- You can revoke sharing access at any time
- Shared content remains subject to these Terms for all participants
...
- The App is designed to work offline with local data storage
- Data syncs automatically when an internet connection is available
- We are not responsible for data conflicts that may arise from extended offline use across multiple devices

---

## 8. Service Availability

- We strive to maintain the App's availability but do not guarantee uninterrupted service
...
- Our total liability shall not exceed the amount you paid for the App in the preceding 12 months
- We are not responsible for any loss of data, though we make reasonable efforts to prevent such loss

---

## 10. Indemnification

You agree to indemnify and hold harmless Pranta Dutta and Odyssey from any claims, damages, or expenses arising from your use of the App or violation of these Terms.
...
We may update these Terms from time to time. We will notify you of significant changes through the App. Continued use of the App after changes constitutes acceptance of the updated Terms.
